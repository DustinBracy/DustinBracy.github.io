...
![](./figures/bank/corrPlot.png){width="4.5in" height="4.5in"} 

```{r EDA_CorrPlot, out.height=500, out.width=500, fig.align="center", fig.cap='Correlation Plot', echo=FALSE}

#knitr::include_graphics('./figures/bank/corrPlot.png')
...
![](./figures/bank/variableImportance.png){width="4in" height="4in"} 
...
![](./figures/bank/PCA.png){width="7.5in"} 
...
![](./figures/bank/ROClogistic.png){width="4.5in"}  
...
![](./figures/bank/LRT.png){width="5in"} 
...
![](./figures/bank/vif_before.png){width="4.5in"} 
...
![](./figures/bank/vif_after.png){width="4.5in"} 
...
We evaluated the Cook's D Plot and Leverage plot to assess assumption violations. Cook's D did not return a value above 0.0020, showing that there are no significant outliers to consider.  The Residual Leverage plot also supports this, with only one value above 0.020.    
  ...
  ![](./figures/bank/ResidualLeverage.png){width="7.5in"}
...
![](./figures/bank/WaldLRT.png){width="7.5in"}     
...
![](./figures/bank/hoslem.png){width="5in"}   
...
![](./figures/bank/probslogisticmodel.png){width="7.5in"} 
...
![](./figures/bank/summarylogistic.png){width="4.5in"}   

To access just the coefficients for this model, we use the coef() function.  


![](./figures/bank/coeflogistic.png){width="7.5in"}  
...
![](./figures/bank/CIsLogistic.png){width="7.5in"}
...
bankfull = read.csv("./data/bank-additional-full.csv",header = TRUE, sep = ";")
...
### Correlation Plot 
##### ![](./figures/bank/bank/corrPlot.png)
\newpage
### Scatterplot Matrix  
##### ![](./figures/bank/Scatterplot Matrix.png)
\newpage
### Generalized Pairs Plot  
##### ![](./figures/bank/pairs.png)
\newpage
### Alt Correlation Plot  
##### ![](./figures/bank/ggcorr.png)
